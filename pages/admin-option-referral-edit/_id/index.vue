<template>
  <main>
    <h1 class="my-3">Edit Referral Option:</h1>
...
export default {
  async asyncData(context) {
    ...
    const referralOption = await api.getReferralOption(context.route.params.id);
  ...
  methods: {
    updataReferralOption: function() {
      ...
      if (!(this.group === "" || this.name === "")) {
        this.api
          .updateReferralOption(this.$route.params.id, payload)
          .then(data => {
